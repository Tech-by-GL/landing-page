...
const modules = [
  {
    ...
    description:
      "Learn to use English in daily communication like shopping, asking for directions, or describing your day.",
    icon: "🛒",
  },
  {
    title: "School Subjects",
    description:
      "Build vocabulary and grammar skills through topics like science, math, and history – all in English.",
    icon: "📚",
  },
  {
    title: "Grammar in Use",
    description:
      "Master grammar structures needed to pass the KET exam and speak more clearly.",
    icon: "🧠",
  },
  {
    title: "Speaking Practice",
    description:
      "Practice common speaking tasks and conversations that appear in the KET test.",
    icon: "🗣️",
  },
  {
    title: "Reading & Writing",
    description:
      "Develop strong reading comprehension and short writing skills through practical exercises.",
    icon: "📝",
  },
  {
    title: "Listening Skills",
    description:
      "Train to understand spoken English in various accents, speeds, and real-life situations.",
    icon: "🎧",
  },
];
    ...
    <div className="bg-gray-50">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container-custom grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full h-[450px] rounded-2xl overflow-hidden shadow-xl transform transition-transform duration-500 hover:scale-105">
            <Image
              src="https://chamchi.sgp1.cdn.digitaloceanspaces.com/website/6.png" // 👉 Thay bằng ảnh thật
          ...
          <div>
            ...
            <p className="text-base text-gray-700 mb-6">
              Cô <strong>Thanh Hoa (Kế Toán Viên)</strong> đã đăng ký khóa học
              Tiếng Anh Giao Tiếp để nâng cao kỹ năng giao tiếp trong công việc.
              Sau 14 tháng học tập tại Chăm Chỉ, cô đã có thể tự tin giao tiếp
