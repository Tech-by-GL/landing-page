      ...
      <div className="container-custom">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3 md:mb-4">
            Giá trị cốt lõi của <span className="text-primary">Chăm Chỉ</span>
          </h2>
          <p className="text-base md:text-lg text-gray-700">
            Chúng tôi tin rằng chỉ cần được đồng hành và hỗ trợ đúng cách, học sinh sẽ phát huy hết tiềm năng của
            mình. 
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 text-center">Đồng Hành</h3>
            <p className="text-sm md:text-base text-gray-700 text-center">
              Chúng tôi đồng hành cùng học sinh và phụ huynh trong hành trình học tập, cung cấp sự hỗ trợ và tư vấn
              tận tình để giúp các em phát triển toàn diện. 
            </p>
          </motion.div>
          ...
          >
            ...
            <h3 className="text-lg md:text-xl font-bold text-gray-900 mb-3 md:mb-4 text-center">Hạnh Phúc</h3>
            <p className="text-sm md:text-base text-gray-700 text-center">
